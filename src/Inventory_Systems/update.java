 ...
 public Connection getConnection()
    {
        Connection con;
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost/goodsinventory_db","root","");
            return con;
        }catch (Exception e)  {
            e.printStackTrace();
            return null;
    ...
    public ArrayList<Product> goodsList()
    {
        ...
        String query ="SELECT * FROM `goods_db";
        Statement st;
        ResultSet rs; 
        ...
        try{
            ...
            while(rs.next())
            {
                //goods= new Product(rs.getString("Product Deacription"),rs.getFloat("Product Code"),rs.getFloat("Cost Per Day($)"));
                //goodsList.add(goods);
            }
    ...
    public void Show_products_In_JTable()
    {
       Product product= new Product();
        ...
        {
            row[0]=  product.getProducts().get(i).getDesc();
            row[1]=  product.getProducts().get(i).getCode();
            row[2]=  product.getProducts().get(i).getCost();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("New Product Description");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel5.setText("New Product Code");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setText("New Cost Per Day($)");
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "New Product Description", "New Product Code", "New Cost Per Day($)"
            }
        ));
...
String query="UPDATE `goods_db` SET `Product Description`=['"+jTextField6.getText()+"',`Cost Per Day($)`="+jTextField5.getText()+"+ WHERE `Product Code`="+jTextField4.getText();
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
        Product product = new Product();
        product.setCode(jTextField4.getText());
        product.setDesc(jTextField6.getText());
        product.setCost((float) Double.parseDouble(jTextField5.getText()));
        
        boolean result=product.updateProduct(product);
